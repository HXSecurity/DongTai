        ...
        [
            {
                ...
                "value": {
                    ...
                    "data": [
                        {
                            ...
                            "language": "JAVA",
                            "agent_name": "Mac OS X-bogon-v1.0.0-0c864ba2a60b48aaa1a8b49a53a6749b",
                            "signature_value": "f744df92326c4bea7682fd16004bec184148db07",
                            "level": "INFO",
                            "level_type": 4,
                            "vul_count": 0,
                            "dt": 1631189450,
                    ...
                    "page": {"alltotal": 795, "num_pages": 795, "page_size": 1},
                },
            }
        ],
        tags=[_("Component")],
...
def get_vul_list_from_elastic_searchv2(
    ...
    search = (
        ...
        .extra(**extra_dict)
        .sort(*order_list)[: page_size * WINDOW_SIZE]
    )
...
def mysql_search(
    ...
    final_sql = """SELECT ia2.* FROM iast_asset ia2
        ...
        where_place=" AND ".join(where_conditions) if where_conditions else "1 = 1",
        order_place=" , ".join(order_conditions) if order_conditions else "NULL",
        size="%(size)s",
    )

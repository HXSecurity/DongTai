...
class ExtenalApiTestCase(TestCase):
    def test_get_package_vul_by_aql(self):
        res = get_package_vul(aql="maven:com.fasterxml.jackson.core:jackson-databind:2.9.3:")
        assert isinstance(res, list)

    def test_get_package_by_ecosystem_and_hash_java(self):
        res = get_package(ecosystem="maven", package_hash="3490508379d065fe3fcb80042b62f630f7588606")
        assert isinstance(res, list)

    def test_get_package_by_ecosystem_and_hash_go(self):
        res = get_package(ecosystem="golang", package_hash="3c61e56652c8d48ba09390f1170cf868007e1293")
        assert isinstance(res, list)

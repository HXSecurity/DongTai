...
from dongtai_web.dongtai_sca import Package, VulPackageVersion, VulPackage, VulPackageRange, Vul, VulCveRelation, PackageLicenseInfo, \
    PackageLicenseLevel
...
from dongtai_web.dongtai_sca import GetScaVulData

...
dongtai-mysql: 
    image: registry.cn-beijing.aliyuncs.com/huoxian_pub/dongtai-mysql:1.0.4
    restart: always
    volumes:
...
dongtai-redis:
    image: registry.cn-beijing.aliyuncs.com/huoxian_pub/dongtai-redis:1.0.4
    restart: always
...
services:
  ...
  $REDIS_STR
  dongtai-webapi:
    image: registry.cn-beijing.aliyuncs.com/huoxian_pub/dongtai-webapi:1.0.4
    restart: always
    volumes:
      - \$PWD/config-tutorial.ini:/opt/dongtai/webapi/conf/config.ini

  dongtai-web:
    image: registry.cn-beijing.aliyuncs.com/huoxian_pub/dongtai-web:1.0.4
    restart: always
    ports:
      - "$WEB_SERVICE_PORT:80"
    volumes:
  ...
  dongtai-openapi:
    image: registry.cn-beijing.aliyuncs.com/huoxian_pub/dongtai-openapi:1.0.4
    restart: always
    volumes:
  ...
  dongtai-engine:
    image: registry.cn-beijing.aliyuncs.com/huoxian_pub/dongtai-engine:1.0.4
    restart: always
    volumes:

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signature_value', models.CharField(blank=True, max_length=255)),
                ('version', models.CharField(blank=True, max_length=255)),
                ('level', models.IntegerField(blank=True, choices=[(4, '严重'), (3, '高危'), (2, '中危'), (1, '低危'), (0, '无风险')], db_column='level_id', default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, error_messages={'unique': 'A department with that department name already exists.'}, max_length=100, unique=True, verbose_name='name')),
                ('create_time', models.IntegerField(blank=True, default=dongtai_common.utils.db.get_timestamp, verbose_name='create time')),
                ('update_time', models.IntegerField(blank=True, default=dongtai_common.utils.db.get_timestamp, verbose_name='update time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.IntegerField(blank=True, default=dongtai_common.utils.db.get_timestamp, null=True)),
                ('update_time', models.IntegerField(blank=True, default=dongtai_common.utils.db.get_timestamp, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vul_name', models.CharField(blank=True, max_length=255)),
                ('vul_detail', models.TextField()),
                ('level', models.IntegerField(blank=True, choices=[(4, '严重'), (3, '高危'), (2, '中危'), (1, '低危'), (0, '无风险')], db_column='level_id', default=1)),
                ('update_time', models.IntegerField()),
                ('create_time', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vul_validation', models.IntegerField(choices=[(None, 0), (0, 'Follow Global'), (1, 'Enable'), (2, 'Disable')], default=0)),
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.department')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.IntegerField(default=dongtai_common.utils.db.get_timestamp, verbose_name='create time')),
                ('update_time', models.IntegerField(default=dongtai_common.utils.db.get_timestamp, verbose_name='update time')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastproject')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system_type', models.IntegerField(blank=True, default=0)),
                ('hook_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.hooktype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('talent_name', models.CharField(blank=True, error_messages={'unique': 'A talent with that talent name already exists.'}, max_length=255, unique=True, verbose_name='talent')),
                ('create_time', models.IntegerField()),
                ('update_time', models.IntegerField()),
                ('created_by', models.IntegerField()),
                ('is_active', models.BooleanField(default=True, help_text='Designates whether this user should be treated as active. Unselect this instead of deleting accounts.', verbose_name='active')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastagent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastagent')),
                ('sinks', models.ManyToManyField(blank=True, related_name='method_pools', related_query_name='method_pool', to='dongtai_common.HookStrategy', verbose_name='sinks')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strategy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iaststrategymodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastagent')),
                ('hook_type', models.ForeignKey(db_column='hook_type_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.hooktype')),
                ('level', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastvullevel')),
                ('project', models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastproject')),
                ('project_version', models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastprojectversion')),
                ('server', models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastserver')),
                ('status', models.ForeignKey(db_column='status_id', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastvulnerabilitystatus')),
                ('strategy', models.ForeignKey(db_column='strategy_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iaststrategymodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_vul', models.ForeignKey(db_constraint=False, default=-1, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastassetvul')),
                ('user', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('vul', models.ForeignKey(db_constraint=False, default=-1, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastvulnerabilitymodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iastvul', models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastvulnerabilitymodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset', models.ForeignKey(db_column='asset', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.assetv2global', to_field='aql')),
                ('asset_vul', models.ForeignKey(db_column='vul_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastassetvulv2', to_field='vul_id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_del', models.SmallIntegerField(default=0)),
                ('create_time', models.IntegerField()),
                ('asset', models.ForeignKey(db_column='asset_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.asset')),
                ('asset_vul', models.ForeignKey(db_column='asset_vul_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastassetvul')),
                ('status', models.ForeignKey(db_column='status_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastvulnerabilitystatus')),
                ('vul_asset_metadata', models.ForeignKey(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastassetvulrelationmetadata')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(db_column='agent_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastagent')),
                ('project', models.ForeignKey(blank=True, db_constraint=False, default=-1, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastproject')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.department')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latest_time', models.IntegerField(default=dongtai_common.utils.db.get_timestamp)),
                ('pattern_type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastpatterntype')),
                ('strategy', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iaststrategymodel')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastagent')),
                ('payload', models.ForeignKey(blank=True, default=-1, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastvulrecheckpayload')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, db_constraint=False, default=-1, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastproject')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_gather_is_followglobal', models.IntegerField(default=1)),
                ('blacklist_is_followglobal', models.IntegerField(default=1)),
                ('scan', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iaststrategyuser')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='scan',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iaststrategyuser'),
        ),
        migrations.AddField(
            model_name='iastproject',
            name='template',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastprojecttemplate'),
        ),
        migrations.AddField(
            model_name='iastproject',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_type', models.ForeignKey(db_column='message_type_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastmessagetype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='heartbeats', related_query_name='heartbeat', to='dongtai_common.iastagent', verbose_name='agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('res_header', models.TextField(blank=True)),
                ('agent', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastagent')),
                ('header_vul', models.ForeignKey(blank=True, db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastheadervulnerability')),
                ('method_pool', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.methodpool')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(db_constraint=False, default=-1, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastproject'),
        ),
        migrations.AddField(
            model_name='iastheadervulnerability',
            name='project_version',
            field=models.ForeignKey(db_constraint=False, default=-1, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastprojectversion'),
        ),
        migrations.AddField(
            model_name='iastheadervulnerability',
            name='vul',
            field=models.ForeignKey(db_constraint=False, default=-1, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastvulnerabilitymodel'),
        ),
        migrations.CreateModel(
            name='IastErrorlog',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dt_mark', models.CharField(blank=True, max_length=255)),
                ('dastvul', models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastdastintegration')),
                ('iastvul', models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastvulnerabilitymodel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastproject'),
        ),
        migrations.AddField(
            model_name='iastdastintegration',
            name='project_version',
            field=models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastprojectversion'),
        ),
        migrations.AddField(
            model_name='iastdastintegration',
            name='vul_level',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastvullevel'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('circuit_config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastcircuitconfig')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset_vul', models.ForeignKey(db_column='asset_vul_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastassetvul')),
                ('asset_vul_type', models.ForeignKey(db_column='asset_vul_type_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastassetvultype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(db_column='agent_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastagent')),
                ('method', models.ForeignKey(db_column='method_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastapimethod')),
                ('project', models.ForeignKey(default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastproject')),
                ('project_version', models.ForeignKey(default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastprojectversion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route', models.ForeignKey(db_column='route_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastapiroute')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('api_method', models.ForeignKey(db_column='api_method_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastapimethod')),
                ('http_method', models.ForeignKey(db_column='http_method_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.httpmethod')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='http_method',
            field=models.ManyToManyField(through='dongtai_common.IastApiMethodHttpMethodRelation', to='dongtai_common.HttpMethod'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastagent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='new_events', to='dongtai_common.iastagent')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='bind_project',
            field=models.ForeignKey(default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastproject'),
        ),
        migrations.AddField(
            model_name='iastagent',
            name='department',
        ...
        migrations.AddField(
            model_name='iastagent',
            name='project_version',
            field=models.ForeignKey(default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastprojectversion'),
        ),
        migrations.AddField(
            model_name='iastagent',
            name='server',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='agents', related_query_name='agent', to='dongtai_common.iastserver', verbose_name='server'),
        ),
        migrations.AddField(
            model_name='iastagent',
            name='user',
        ...
        migrations.AddField(
            model_name='hooktype',
            name='language',
            field=models.ForeignKey(blank=True, db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastprogramlanguage'),
        ),
        migrations.AddField(
            model_name='hooktype',
            name='vul_strategy',
            field=models.ForeignKey(blank=True, db_column='strategy_id', db_constraint=False, default=-1, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iaststrategymodel'),
        ),
        migrations.AddField(
            model_name='hookstrategy',
            name='hooktype',
            field=models.ForeignKey(blank=True, help_text='The department this user belongs to. A user will get all permissions granted to each of their department.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='strategies', related_query_name='strategy', to='dongtai_common.hooktype', verbose_name='type'),
        ),
        migrations.AddField(
            model_name='hookstrategy',
            name='language',
        ...
        migrations.AddField(
            model_name='hookstrategy',
            name='strategy',
            field=models.ForeignKey(db_column='strategy_id', db_constraint=False, default=-1, on_delete=django.db.models.deletion.DO_NOTHING, related_name='strategies', related_query_name='strategy', to='dongtai_common.iaststrategymodel'),
        ),
        migrations.AddField(
            model_name='department',
            name='talent',
            field=models.ManyToManyField(blank=True, help_text='The talent this department belongs to. A department will get all permissions granted to each of their talent.', related_name='departments', related_query_name='talent', to='dongtai_common.Talent', verbose_name='talent'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='package_fullname', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastpackagegainfo', to_field='package_fullname'),
        ),
        migrations.CreateModel(
            name='AssetV2',
            fields=[
                ...
                ('version', models.CharField(blank=True, max_length=255)),
                ('language_id', models.IntegerField(blank=True, default=1)),
                ('aql', models.ForeignKey(blank=True, db_column='aql', on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.assetv2global', to_field='aql')),
                ('department', models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.department')),
                ('project', models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastproject')),
                ('project_version', models.ForeignKey(blank=True, default=-1, on_delete=django.db.models.deletion.CASCADE, to='dongtai_common.iastprojectversion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license', models.CharField(blank=True, max_length=64)),
                ('is_del', models.SmallIntegerField(default=0)),
                ('level', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastvullevel')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='asset',
            name='agent',
            field=models.ForeignKey(default=-1, on_delete=django.db.models.deletion.CASCADE, related_name='assets', related_query_name='asset', to='dongtai_common.iastagent', verbose_name='agent'),
        ),
        migrations.AddField(
            model_name='asset',
            name='department',
            field=models.ForeignKey(default=-1, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.department'),
        ),
        migrations.AddField(
            model_name='asset',
            name='level',
            field=models.ForeignKey(default=4, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.iastvullevel'),
        ),
        migrations.AddField(
            model_name='asset',
            name='project',
        ...
        migrations.AddField(
            model_name='asset',
            name='talent',
            field=models.ForeignKey(default=-1, on_delete=django.db.models.deletion.DO_NOTHING, to='dongtai_common.talent'),
        ),
        migrations.AddField(
            model_name='asset',
            name='user',
        ...
        migrations.AddField(
            model_name='user',
            name='department',
            field=models.ManyToManyField(blank=True, help_text='The department this user belongs to. A user will get all permissions granted to each of their department.', related_name='users', related_query_name='user', to='dongtai_common.Department', verbose_name='department'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',

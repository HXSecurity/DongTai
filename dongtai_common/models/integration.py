...
class IastVulInegration(models.Model):
    ...
    vul = models.ForeignKey(to=IastVulnerabilityModel, on_delete=models.DO_NOTHING, blank=True, null=True, default=-1)
    asset_vul = models.ForeignKey(to=IastAssetVul, on_delete=models.DO_NOTHING, blank=True, default=-1)

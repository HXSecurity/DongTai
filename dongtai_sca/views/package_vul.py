...
from dongtai_sca.models import Package, VulPackageVersion, VulPackage, VulPackageRange, Vul, VulCveRelation, PackageLicenseInfo, \
    PackageLicenseLevel
...
from dongtai_sca.common.sca_vul import GetScaVulData
